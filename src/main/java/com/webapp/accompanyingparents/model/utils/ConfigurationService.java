 ...
 */
package com.webapp.accompanyingparents.model.utils;
...
public class ConfigurationService extends PropertiesConfiguration implements ConfigurationListener {
    private static final String PROPS_RESOURCE = System.getProperty("spring.config.location") != null ?
            (System.getProperty("spring.config.location") + "config.properties") : "config.properties";
